...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<li :data-id=\"id\" class=\"list-group-item lt box-shadow-z0 b\">\n    <a :href=\"ref_url\">\n    <span class=\"pull-left m-r\" v-if=\"img_src\">\n        <img :src=\"img_src\" class=\"w-40 img-circle\">\n    </span>\n    <span class=\"clear block\">\n        {{ title }}\n        <small class=\"text-muted block\">\n            <timestamp :timestamp=\"created_at\"></timestamp>\n        </small>\n    </span>\n    </a>\n</li>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-034691a9", module.exports)
  } else {
    hotAPI.update("_v-034691a9", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
    ...
    methods: {
        getNotices: function getNotices() {
            ...
            this.$http.get(this.endpoint).then(function (response) {
                _this2.notices = response.body.data.notices.data;
                _this2.updateUnreadTotal(response.body.data.unread);
                _this2.fetched = true;
            }, function (response) {}).finally(function () {
                $Bus.$emit('fetching:notices', false);
            });
        },
        updateUnreadTotal: function updateUnreadTotal(notices) {
            this.unread = notices;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6937449a", module.exports)
  } else {
    hotAPI.update("_v-6937449a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
new Vue({
    ...
    created: function created() {
        ...
        $Bus.$on('fetching:notices', function (status) {
            _this.fetching_new_notices = status;
        });
        $Bus.$on('unread:updated', function (notices) {
            _this.updateUnreadTotalsEl(notices);
        });
    },

    methods: {
        updateUnreadTotalsEl: function updateUnreadTotalsEl(notices) {
            this.unread = notices;
            var notifyEl = $('#notify_total');
            notifyEl.removeClass('hide');
            if (notices.length == 0) {
                notifyEl.addClass('hide');
            }
        },
        markUnreadAsRead: function markUnreadAsRead(endpoint) {
            var _this2 = this;

            if (this.fetching_new_notices == true || this.unread.length == 0) {
                return false;
            }
            var ids = _.pluck(this.unread, 'id');
            this.$http.post(endpoint, { ids: ids }, {
                ...
                _this2.updateUnreadTotalsEl([]);
            });
        }
    },
    components: {
        'notices': _Notices2.default
    }
});
