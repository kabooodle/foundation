    ...
    computed: {
        has_error: function has_error() {
            if (this.use_error_helper) {
                var error_obj = this.errors && this.errors.hasOwnProperty(this.field_name) ? this.errors[this.field_name] : false;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2d3411e5", module.exports)
  } else {
    hotAPI.update("_v-2d3411e5", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./spinner":12,"vue":4,"vue-hot-reload-api":2}],9:[function(require,module,exports){
"use strict";
...
var _InlineFieldCustom = require('../InlineFieldCustom.vue');

var _InlineFieldCustom2 = _interopRequireDefault(_InlineFieldCustom);
...
exports.default = {
    ...
    data: function data() {
        return {
            currentUser: (0, _currentUser2.default)(),
            form_errors: [],
            events: {
                saving: false,
                mounted: false,
    ...
    methods: {
        ...
        populateClaims: function populateClaims() {
            ...
            $.each(data, function (k, v) {
                // var group = $('<optgroup label="' + k + '" />');
                var preselected = /[?&]c=/.test(location.search);
                ...
                $.each(v, function () {
                    ...
                    $('<option ' + ' ' + typeAttr + ' ' + ' ' + claimerAttr + ' ' + ' ' + selected + ' ' + 'value="' + this.value + '"  ' + 'data-date="' + this.date + '" ' + 'data-image="' + this.image + '">').html(this.name).prependTo(claimedEl);
                });
...
var _ShippingParcelForm = require('./ShippingParcelForm.vue');

var _ShippingParcelForm2 = _interopRequireDefault(_ShippingParcelForm);
...
new Vue({
    ...
    created: function created() {
        ...
        $Bus.$on('parcel:saved', function (parcel, rates, shipment) {
            _this.completed_steps.parcel = true;
            _this.rates = rates;
    ...
    methods: {
        viewParcelData: function viewParcelData() {
            this.completed_steps.parcel = false;
            this.rates = [];
            this.shipment = {};
        },
        purchaseLabel: function purchaseLabel(url, uuid, event) {
            var _this2 = this;
            ...
            confirmModal(function () {
                ...
                var form_data = {
                    rate_uuid: uuid,
                    parcel_id: parseInt(_this2.shipment.id)
                };

                _this2.$http.post(url, form_data).then(function (response) {
    ...
    components: {
        ...
        'shipping-parcel-form': _ShippingParcelForm2.default
    }
});

},{"../InlineField.vue":5,"../Modal.vue":7,"../Spinner.vue":8,"./ShippingParcelForm.vue":10}],12:[function(require,module,exports){
'use strict';
