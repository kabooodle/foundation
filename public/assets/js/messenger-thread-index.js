...
exports.default = {
    ...
    computed: {
        author_is_self: function author_is_self() {
            return parseInt(this.message.user_id) == parseInt((0, _currentUser2.default)().id);
        }
    },
    components: {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-762c39be", module.exports)
  } else {
    hotAPI.update("_v-762c39be", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('messages:fetched', function (messages, thread) {
            _this.ready = true;
        });
    },
    ...
    methods: {
        storeResponse: function storeResponse(event) {
            ...
            this.sending = true;
            this.ready = false;
            this.$http.put(this.endpoint, { msg: this.msg }).then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-72fe4aa7", module.exports)
  } else {
    hotAPI.update("_v-72fe4aa7", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    created: function created() {
        ...
        var messageChannel = KABOOODLE_APP.pusher.subscribe('presence.' + KABOOODLE_APP.env + '.threads.' + this.thread.id);
        messageChannel.bind('response:added', function (data) {
            _this.messages.push(data.message);
            $Bus.$emit('messages:fetched', _this.thread, _this.messages);
        });

        $Bus.$on('messages:fetched', function (thread, messages) {
            _this.flagAsRead(thread, messages);
        });
    },
    ...
    methods: {
        fetchThread: function fetchThread() {
            ...
            this.$http.get(this.endpoint).then(function (response) {
                _this2.messages = response.body.data;
                _this2.fetching = false;
                $Bus.$emit('messages:fetched', _this2.thread, _this2.messages);
            }, function (response) {});
        },
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <spinny v-if=\"fetching\" :size=\"'' + 28\" class=\"text-center center-block\"></spinny>\n    <message v-if=\"messages\" v-for=\"message in messages\" :message=\"message\"></message>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-53069f25", module.exports)
  } else {
    hotAPI.update("_v-53069f25", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _MessageRespond = require('./MessageRespond.vue');

var _MessageRespond2 = _interopRequireDefault(_MessageRespond);
...
new Vue({
    ...
    components: {
        ...
        'message-respond': _MessageRespond2.default
    }
});
