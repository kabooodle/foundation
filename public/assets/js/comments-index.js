...
var _commentsIndex = require('./comments-index.vue');

var _commentsIndex2 = _interopRequireDefault(_commentsIndex);
...
new Vue({
    ...
    components: {
        'comments-index': _commentsIndex2.default
    }
});

},{"./comments-index.vue":6}],6:[function(require,module,exports){
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4abd0018", module.exports)
  } else {
    hotAPI.update("_v-4abd0018", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Timestamp.vue":4,"vue":3,"vue-hot-reload-api":2}]},{},[5]);
