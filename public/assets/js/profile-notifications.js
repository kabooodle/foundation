...
exports.default = {
    ...
    methods: {
        fetchPhoneNumber: function fetchPhoneNumber() {
            var _this = this;

            this.fetching = true;
            this.$http.get(this.fetch_endpoint).then(function (response) {
                var phone_object = response.body.data;
                if (phone_object != null) {
                    console.log(phone_object);
                    _this.phone_object = phone_object;
                    _this.exists = true;
                    _this.adding_new = false;
                } else {
                    _this.adding_new = true;
                }
            }).finally(function () {
        ...
        sendVerificationCode: function sendVerificationCode() {
            ...
            this.creating = true;
            this.$http.post(this.create_endpoint, { phone_number: this.phone_number }).then(function (response) {
        ...
        verifyCode: function verifyCode() {
            ...
            this.verifying = true;
            this.$http.put(this.verify_endpoint, { phone_number: this.phone_number, code: this.verification_code }).then(function (response) {
                notify({ text: response.body.data.msg, type: 'success' });
                _this3.exists = true;
                _this3.phone_object = response.body.data.model;
                _this3.verification_code = null;
                _this3.phone_number = null;
                _this3.adding_new = false;
            }, function (response) {
                notify({ text: response.body.data.msg });
            }).finally(function () {
