...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-43ff0f7a", module.exports)
  } else {
    hotAPI.update("_v-43ff0f7a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../../app/s3uploader":58,"../../vendor/fileupload/js/jquery.fileupload":62,"../../vendor/fileupload/js/jquery.fileupload-image":59,"../../vendor/fileupload/js/jquery.fileupload-process":60,"../../vendor/fileupload/js/jquery.fileupload-ui":61,"../../vendor/fileupload/js/jquery.iframe-transport":63,"../../vendor/fileupload/js/vendor/canvas-to-blob.min":64,"../../vendor/fileupload/js/vendor/jquery.ui.widget":65,"../../vendor/fileupload/js/vendor/load-image":66,"./current-user":50,"babel-runtime/core-js/json/stringify":1,"vue":44,"vue-hot-reload-api":42,"vueify/lib/insert-css":45}],47:[function(require,module,exports){
"use strict";
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"form-group row \" :class=\"errors ? 'has-error has-danger' : null\">\n    <label class=\"col-sm-3 control-label form-control-label\">\n        <slot name=\"label\"></slot>\n    </label>\n    <div class=\"col-sm-9\">\n        <slot name=\"input\"></slot>\n        <slot name=\"text-help\"></slot>\n        <template v-if=\"has_error\">\n            <span class=\"text-danger block text-xs\">{{ errors[0] }}</span>\n        </template>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4f66a7d4", module.exports)
  } else {
    hotAPI.update("_v-4f66a7d4", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":44,"vue-hot-reload-api":42}],48:[function(require,module,exports){
'use strict';
...
},{"vue":44,"vue-hot-reload-api":42}],49:[function(require,module,exports){
'use strict';
...
},{"./spinner":57,"vue":44,"vue-hot-reload-api":42}],50:[function(require,module,exports){
"use strict";
...
var _InlineField = require('../InlineField.vue');

var _InlineField2 = _interopRequireDefault(_InlineField);
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('build-group:click', function () {
            _this.openModal();
        });
    },

    computed: {
        data_dirty: function data_dirty() {
            return !((0, _stringify2.default)(this.$data) === (0, _stringify2.default)(initialState()));
        }
    },
    methods: {
        ...
        closeModal: function closeModal(ignoreState) {
            var _this2 = this;
        ...
        searchMembers: function searchMembers(query) {
            var _this3 = this;
            ...
            this.$http.post(this.search_endpoint, { q: query }, {
                ...
                _this3.search_members = response.body.data.data;
        ...
        saveGroup: function saveGroup() {
            ...
            this.$http.post(this.save_endpoint, payload).then(function (response) {
                var notice = 'Group ' + _this4.name + ' successfully created!';
                notify({ text: notice, type: 'success' });
                setTimeout(function () {
                    var ignoreState = true;
                    _this4.closeModal(ignoreState);
                }, 500);
            }, function (response) {
                if (response.body.data.errors) {
                    _this4.form_errors = response.body.data.errors;
                }
    ...
    components: {
        'inline-field': _InlineField2.default,
...
var _BuildFlashsaleGroup = require('./Build-Flashsale-Group.vue');

var _BuildFlashsaleGroup2 = _interopRequireDefault(_BuildFlashsaleGroup);
...
var _SellerGroup = require('./Seller-Group.vue');

var _SellerGroup2 = _interopRequireDefault(_SellerGroup);
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('flashsale:component:data', function (data) {
            var seller_group_index = _this.seller_groups.indexOf(data);
            if (seller_group_index > -1) {
                _this.seller_groups.splice(seller_group_index, 1);
            }
            _this.seller_groups.push(data);
        });

        $Bus.$on('seller_container:add', function () {
            _this.addSellerContainer();
        });

        $Bus.$on('image:uploaded', function (el, data) {
            _this.cover_photo = data;
        });

        $Bus.$on('flashsale:data:request', function () {
            $Bus.$emit('flashsale:data:payload', _this.$data);
        });

        $Bus.$on('sellergroup:selected', function (group, containerId) {
            ...
            var index = _this.selected_groups.indexOf(group.id);
            if (index > -1) {
                _this.selected_groups.splice(index, 1);
            }

            _this.selected_groups.push(group);

            // Add the group to the corresponding container.
            // This keeps the group associated to the container and a 1 to 1.
            _this.sellers_groups_containers[containerId].selected_group = group;
        });
    },

    methods: {
        _checkIfExistingData: function _checkIfExistingData() {
            var _this2 = this;

            if (this.existing_data && _.size(this.existing_data) > 0) {
                this.isEditing = true;

                var data = this.existing_data;
                ...
                if (data.seller_groups.length > 0) {
                    _.each(data.seller_groups, function (k, b) {
                        _this2.addSellerContainer(k.id, k);
                        _this2.selected_groups.push(k);
                    });
                }
        ...
        searchAdmins: function searchAdmins(query) {
            var _this3 = this;
            ...
            this.$http.post(this.search_endpoint, { q: query }, {
                ...
                _this3.search_admins = response.body.data.data;
                _this3.loading.admins = false;
            });
        },
        addSellerContainer: function addSellerContainer(id, selected_group, $event) {
        ...
        removeSellerContainer: function removeSellerContainer(container) {
            var _this4 = this;
            ...
            confirmModal(function ($noty) {
                ...
                var associated_group = container.selected_group;

                // Get the index of the container in the sellers groups containers
                var container_index = _this4.sellers_groups_containers.indexOf(container);

                if (container_index > -1) {
                    // Remove the container
                    _this4.sellers_groups_containers.splice(container_index, 1);
                    ...
                    if (associated_group && associated_group.id) {
                        var selected_group_index = _this4.selected_groups.indexOf(associated_group);
                        _this4.selected_groups.splice(selected_group_index, 1);
                    }
                }

                // Reset some annoying data.
                _this4.seller_groups = [];

                $noty.close();
            });
        },
        saveFlashsale: function saveFlashsale() {
            var _this5 = this;
            ...
            var actualIds = _.pluck(_.pluck(this.sellers_groups_containers, 'selected_group'), 'id');
            this.seller_groups = _.uniq(_.filter(this.seller_groups, function (group) {
            ...
            this.$http[method](this.save_endpoint, this.$data).then(function (response) {
                notify({
                ...
                if (response.body.hasOwnProperty('data') && response.body.data.hasOwnProperty('errors')) {
                    _this5.form_errors = response.body.data.errors;
                }
        ...
        deleteFlashsale: function deleteFlashsale(event) {
            var _this6 = this;

            confirmModal(function ($noty) {
                $noty.close();
                _this6.isDeleting = true;
                _this6.$http.delete(_this6.save_endpoint).then(function (response) {
                    notify({
                        text: response.body.data.msg,
                        type: 'success'
                    });
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('flashsale:saving', function () {
            $Bus.$emit('flashsale:component:data', {
                id: _this.group.id,
                time_slot: _this.time_slot
            });
        });
    },

    methods: {
        clearTimeSlot: function clearTimeSlot() {
            this.time_slot = null;
        ...
        groupSelected: function groupSelected(option, id) {
            $Bus.$emit('sellergroup:selected', option, this.id);
        },
        searchGroups: function searchGroups(query) {
            var _this2 = this;
            ...
            this.$http.post(this.search_endpoint, { q: query, exclude: _.pluck(this.selected_groups, 'id') }, {
                ...
                _this2.seller_groups = response.body.data.data;
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<span :id=\"'group_'+id\">\n    <inline-field>\n        <template slot=\"label\">Group</template>\n        <template slot=\"input\">\n            <multiselect :disabled=\"this.existing_group ? true : false\" label=\"name\" track-by=\"id\" placeholder=\"Select a group\" v-model=\"group\" :options=\"seller_groups\" :multiple=\"false\" :searchable=\"true\" :loading=\"loading.groups\" :internal-search=\"false\" :clear-on-select=\"true\" :close-on-select=\"true\" :options-limit=\"10\" :limit=\"10\" @select=\"groupSelected\" @search-change=\"searchGroups\">\n                <template slot=\"option\" scope=\"props\">\n                    <div class=\"option__desc\">\n                        <span class=\"option__title\">{{ props.option.name }} ({{ props.option.users.length }} members)</span>\n                    </div>\n                </template>\n            </multiselect>\n        </template>\n    </inline-field>\n\n    <inline-field class=\"m-b-0\">\n        <template slot=\"label\">Time slot</template>\n        <div slot=\"input\" v-if=\"existing_time_slot\">\n            <input disabled=\"true\" readonly=\"true\" type=\"text\" class=\"form-control\" v-model=\"time_slot\" :value=\"time_slot\" name=\"\">\n        </div>\n        <div class=\"input-group\" slot=\"input\" v-else=\"\">\n            <input @blur=\"updateDateTimeEl('time_slot', $event)\" type=\"text\" class=\"time_slot form-control\" v-model=\"time_slot\" :value=\"time_slot\" name=\"\">\n            <span class=\"input-group-btn\">\n                <button data-toggle=\"tooltip\" title=\"Clear\" data-placement=\"top\" class=\"btn white\" style=\"padding-bottom:5px\" @click.prevent=\"clearTimeSlot\"><i class=\"fa fa-times-circle-o\" aria-hidden=\"true\"></i></button>\n            </span>\n        </div>\n        <span class=\"text-xs text-muted\" slot=\"text-help\">(optional)</span>\n        <span class=\"text-xs text-muted block\" slot=\"text-help\">Assign a time slot for when the group's items will post to the flashsale</span>\n    </inline-field>\n</span>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0684da52", module.exports)
  } else {
    hotAPI.update("_v-0684da52", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../InlineField.vue":47,"vue":44,"vue-hot-reload-api":42,"vue-multiselect":43}],54:[function(require,module,exports){
'use strict';

var _BuildFlashsale = require('./Build-Flashsale.vue');

var _BuildFlashsale2 = _interopRequireDefault(_BuildFlashsale);
...
new Vue({
    ...
    components: {
        'build-flashsale': _BuildFlashsale2.default
    }
});

},{"./Build-Flashsale.vue":52}],55:[function(require,module,exports){
'use strict';
...
},{"../onboard":56}],56:[function(require,module,exports){
'use strict';
...
},{"intro.js":40}],57:[function(require,module,exports){
'use strict';
...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        _renderExtendedProgress: function _renderExtendedProgress(data) {
            return this._renderStrongTmpl(this._formatPercentage(data.loaded / data.total)) + ' at ' + this._renderStrongTmpl(this._formatBitrate(data.bitrate)) + ' &middot; about ' + this._renderStrongTmpl(this._formatTime((data.total - data.loaded) * 8 / data.bitrate)) + ' left ' + '<em>(' + this._formatFileSize(data.loaded) + ' / ' + this._formatFileSize(data.total) + ')</em>';
        },

        _renderStrongTmpl: function _renderStrongTmpl(string) {
            return '<strong>' + string + '</strong>';
        },

        _renderBreak: function _renderBreak() {
            return '<br>';
        },
