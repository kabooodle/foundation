...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6cd42025", module.exports)
  } else {
    hotAPI.update("_v-6cd42025", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0142c01e", module.exports)
  } else {
    hotAPI.update("_v-0142c01e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            group: {},
            hosted_by: null,
            host_options: [HOST_SELF, HOST_GROUP],
            loading: {
                admins: false,
                sellers: false
            },
    ...
    computed: {
        hosted_by_group: function hosted_by_group() {
    ...
    created: function created() {
        ...
        $Bus.$on('image:uploaded', function (el, data) {
            _this.cover_photo = data.location;
        });
    },
    ...
    methods: {
        ...
        searchAdmins: function searchAdmins(query) {
            ...
            this.$http.post(this.search_endpoint, { q: query }, {
                ...
                _this2.admins_list = response.body.data.data;
                _this2.loading.admins = false;
            });
        },
        searchSellers: function searchSellers(query) {
            var _this3 = this;
            ...
            this.$http.post(this.search_endpoint, { q: query }, {
                ...
                _this3.sellers_list = response.body.data.data;
                _this3.loading.sellers = false;
            });
        }
    },
    components: {
