...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-79ba6eac", module.exports)
  } else {
    hotAPI.update("_v-79ba6eac", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-8c081b7a", module.exports)
  } else {
    hotAPI.update("_v-8c081b7a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Spinner.vue":8,"vue":3,"vue-hot-reload-api":2}],10:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-63a07888", module.exports)
  } else {
...
},{"../Spinner.vue":8,"../facebook/FacebookLogin.vue":9,"./Listing-Settings.vue":10,"./manage/computed":12,"./manage/store":14,"./style_template.vue":15}],12:[function(require,module,exports){
'use strict';
...
},{"./state":13,"vuex":5}],15:[function(require,module,exports){
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('inventory:select-all', function () {
            $.each(_this.listed_items, function () {
        ...
        $Bus.$on('inventory-item:updated', function (item, updatedItem) {
            ...
            _.each(_this.listed_items, function (style, index) {
            ...
            // find the size index.
            _.each(_this.listed_items[styleIndex].sizes, function (size, index) {
            ...
            // find the item index/
            _.each(scope.listed_items[styleIndex].sizes[sizeIndex].items, function (listedItem, index) {
            ...
            // update the state.
            _this.listed_items[styleIndex].sizes[sizeIndex].items[itemIndex] = updatedItem;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-60d90d78", module.exports)
  } else {
