...
exports.default = {};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"onboard-card onboard_wrapper\">\n    <div class=\"onboard-body text-center\">\n        <h1 class=\"onboard-card-title\">\n            <slot name=\"title\"></slot>\n        </h1>\n        <h2 class=\"onboard-card-sub-title text-center m-b-3\">\n           <slot name=\"subtext\"></slot>\n        </h2>\n        <slot name=\"extra\"></slot>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4af0ef0a", module.exports)
  } else {
    hotAPI.update("_v-4af0ef0a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    data: function data() {
        return {
            promptOnClose: true,
            defaultContent: '<div class="text-center center-block" ' + 'style="position: absolute; top: 50%; margin-top: -20px; margin-left: -20px; left: 50%; ">' + '<img src="' + KABOOODLE_APP.makeStaticAsset("assets/images/icons/ring-alt.gif") + '"></div>'
        };
    },
    computed: {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2d9a6418", module.exports)
  } else {
    hotAPI.update("_v-2d9a6418", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./spinner":17,"vue":3,"vue-hot-reload-api":2}],10:[function(require,module,exports){
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<span class=\"fb-img-wrapper\">\n    <template v-if=\"authorizedAndLoggedIn\">\n            <spinny v-if=\"refreshing\"></spinny>\n            <a :class=\"refreshing ? 'disabled' : null\" href=\"javascript:;\" @click=\"FBRefresh\" type=\"button\">\n                <img :src=\"refresh_icon\">\n            </a>\n    </template>\n    <template v-if=\"!authorizedAndLoggedIn\">\n            <a :class=\"refreshing ? 'disabled' : null\" href=\"javascript:;\" @click=\"FBLogin\" type=\"button\">\n                <img :src=\"login_icon\">\n            </a>\n    </template>\n</span>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-a1c61152", module.exports)
  } else {
    hotAPI.update("_v-a1c61152", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Spinner.vue":9,"vue":3,"vue-hot-reload-api":2}],11:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-27d0d39c", module.exports)
  } else {
    hotAPI.update("_v-27d0d39c", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Modal.vue":6,"../Spinner.vue":9,"vue":3,"vue-hot-reload-api":2}],12:[function(require,module,exports){
'use strict';
...
var _ListingSettings = require('./Listing-Settings.vue');

var _ListingSettings2 = _interopRequireDefault(_ListingSettings);

var _Spinner = require('../Spinner.vue');

var _Spinner2 = _interopRequireDefault(_Spinner);

var _OnboardCard = require('../OnboardCard.vue');

var _OnboardCard2 = _interopRequireDefault(_OnboardCard);
...
new Vue({
    ...
    created: function created() {
        ...
        $Bus.$emit('drawer:closed', function () {
            alert('hi');
        });
    ...
    components: {
        ...
        'listing-settings': _ListingSettings2.default,
        'onboard-card': _OnboardCard2.default
    }
});

},{"../OnboardCard.vue":7,"../Spinner.vue":9,"../facebook/FacebookLogin.vue":10,"./Listing-Settings.vue":11,"./manage/computed":13,"./manage/store":15,"./style_template.vue":16}],13:[function(require,module,exports){
'use strict';
...
},{"./state":14,"vuex":5}],16:[function(require,module,exports){
...
var _Popover = require('../Popover.vue');
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('inventory-item:updated', function (item, updatedItem) {
            ...
            // find the item index/
            _.each(scope.inventory_items[styleIndex].sizes[sizeIndex].items, function (listedItem, index) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-00878958", module.exports)
  } else {
    hotAPI.update("_v-00878958", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Popover.vue":8,"../Spinner.vue":9,"./manage/computed":13,"vue":3,"vue-hot-reload-api":2,"vueify/lib/insert-css":4}],17:[function(require,module,exports){
'use strict';
