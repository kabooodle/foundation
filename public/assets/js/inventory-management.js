...
new Vue({
    ...
    methods: {
        ...
        postSelectedItemsToSales: function postSelectedItemsToSales(event) {
            ...
            this.$http.post('http://api.kabooodle.dev/inventory/jaketoolson/associate', form_data).then(function (response) {}, function (response) {
                //
            }).then(function () {
...
exports.default = {
    ...
    methods: {
        ...
        changeOverlayContent: function changeOverlayContent(content) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0d810509", module.exports)
  } else {
    hotAPI.update("_v-0d810509", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
