...
var _shippingTransactions = require('./shipping-transactions.vue');

var _shippingTransactions2 = _interopRequireDefault(_shippingTransactions);
...
new Vue({
    ...
    methods: {
        setPropSales: function setPropSales(v) {
            return v.length;
        },
        setPropClaims: function setPropClaims(v) {
            return v.length;
        },
        setPropItem: function setPropItem(v) {
            var firstImg = v ? v[0] : null;
            return firstImg ? '<img style="width: 32px; height: 32px; border-radius: 2px;" src="' + firstImg.location + '">' : null;
        },
        setPropSize: function setPropSize(v) {
            return v.name;
        },
        setPropStyle: function setPropStyle(v) {
            return v.name;
        },
        setPropPrice: function setPropPrice(v) {
            return '$' + v;
        },
    ...
    components: {
        'vuetable': _shippingTransactions2.default
    }
});

},{"./shipping-transactions.vue":5}],5:[function(require,module,exports){
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-70dd22bf", module.exports)
  } else {
    hotAPI.update("_v-70dd22bf", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":3,"vue-hot-reload-api":2}]},{},[4]);

//# sourceMappingURL=shipping-transactions.js.map
