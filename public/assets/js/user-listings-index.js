...
},{"../Spinner.vue":4,"../current-user":5,"vue":3,"vue-hot-reload-api":2}],7:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    computed: {
        normalizedScheduleRange: function normalizedScheduleRange() {
            var starts_at = this.listing.scheduled_for;
            var ends_at = this.listing.scheduled_until;
            var claimable_at = this.listing.claimable_at;
            var claimable_until = this.listing.claimable_until;

            var scheduled = claimable_at ? claimable_at : starts_at;
            var scheduled_end = claimable_until ? claimable_until : ends_at ? ends_at : null;
...
var _UserListing = require('./UserListing.vue');

var _UserListing2 = _interopRequireDefault(_UserListing);
...
exports.default = {
    ...
    methods: {
        fetchListings: function fetchListings() {
            ...
            this.fetching = true;
            this.$http.get(this.listings_endpoint).then(function (response) {
                _this.listings = response.body.data.data;
                _this.makePagination(response.body.data);
    ...
    components: {
        ...
        'user-listing': _UserListing2.default
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <spinny v-if=\"fetching\" :size=\"'' + 28\" class=\"text-center center-block\"></spinny>\n    <div class=\"list white\" v-if=\"listings\">\n        <user-listing v-for=\"listing in listings\" :listing=\"listing\" :listing_endpoint=\"listing_endpoint.replace(/::UUID::/, listing.uuid)\"></user-listing>\n    </div>\n    <div v-if=\"!fetching &amp;&amp; listings.length == 0\">\n        <p class=\"text-center\">User has no scheduled upcoming listings.</p>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3be479de", module.exports)
  } else {
    hotAPI.update("_v-3be479de", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Spinner.vue":4,"./UserListing.vue":8,"vue":3,"vue-hot-reload-api":2}],10:[function(require,module,exports){
'use strict';

var _UserListings = require('./UserListings.vue');
...
var _Watchable = require('../watch/Watchable.vue');
...
new Vue({
    ...
    components: {
        'user-listings': _UserListings2.default,
        'follow': _Followable2.default,
        'watch': _Watchable2.default
    }
});

},{"../follow/Followable.vue":6,"../watch/Watchable.vue":11,"./UserListings.vue":9}],11:[function(require,module,exports){
'use strict';
...
exports.default = {
    props: {
        ...
        current_user_following: {
            type: Array,
            default: function _default() {
                return (0, _currentUser2.default)() ? (0, _currentUser2.default)().following : {};
            }
        },
        followable_id: {
            required: true,
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6c364ddc", module.exports)
  } else {
    hotAPI.update("_v-6c364ddc", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../current-user":5,"vue":3,"vue-hot-reload-api":2}]},{},[10]);

//# sourceMappingURL=user-listings-index.js.map
