...
if (module.hot) {(function () {  var hotAPI = require("vueify/node_modules/vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.reload("data-v-fd500f54", __vue__options__)
  }
})()}
},{"../../app/s3uploader":11,"../../vendor/fileupload/js/jquery.fileupload":15,"../../vendor/fileupload/js/jquery.fileupload-image":12,"../../vendor/fileupload/js/jquery.fileupload-process":13,"../../vendor/fileupload/js/jquery.fileupload-ui":14,"../../vendor/fileupload/js/jquery.iframe-transport":16,"../../vendor/fileupload/js/vendor/canvas-to-blob.min":17,"../../vendor/fileupload/js/vendor/jquery.ui.widget":18,"../../vendor/fileupload/js/vendor/load-image":19,"babel-runtime/core-js/json/stringify":1,"vue":5,"vueify/lib/insert-css":6,"vueify/node_modules/vue-hot-reload-api":7}],9:[function(require,module,exports){
'use strict';
...
},{"./inventory-sizing.vue":10}],10:[function(require,module,exports){
;(function(){
"use strict";
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',_vm._l((_vm.size_containers),function(size_container){return _c('div',[_c('div',{staticClass:"box sizing_container",attrs:{"id":'size_'+size_container.id,"data-container-id":size_container.id}},[_c('div',{staticClass:"box-body clearfix"},[_c('div',{staticClass:"form-group row"},[_c('label',{staticClass:"col-sm-3 form-control-label"},[_vm._v("Size")]),_vm._v(" "),_c('div',{staticClass:"col-sm-9"},[_c('div',{staticClass:"btn-group-prpl",attrs:{"data-toggle":"buttons"}},_vm._l((_vm.sizings),function(size){return _c('label',{staticClass:"form-control-label btn white",staticStyle:{"margin-right":"3px"}},[_c('input',{attrs:{"required":"","aria-required":"true","validation":"required","type":"radio","name":'sizings['+size_container.id +'][size_id]',"id":"option1","autocomplete":"off"},domProps:{"value":size.id}}),_vm._v(" "+_vm._s(size.name)+"\n                            ")])}))]),_vm._v(" "),_c('button',{staticClass:" m-l-1 pull-right btn white btn-xs text-muted ",staticStyle:{"position":"absolute","top":"0","right":"0","border":"0","border-radius":"0","opacity":".3"},attrs:{"type":"button"},on:{"click":function($event){_vm.deleteSizeContainer(size_container)}}},[_c('i',{staticClass:"fa fa-times",attrs:{"aria-hidden":"true"}})])]),_vm._v(" "),_c('div',{staticClass:"row row-horizon clearfix"},_vm._l((size_container.images),function(image,$index){return _c('div',{staticClass:"col-sm-4 thumbnail-container"},[_c('div',{staticClass:"box m-b-0"},[_c('div',{staticClass:"item"},[_c('div',{staticClass:"item-overlay active p-l p-r ",staticStyle:{"z-index":"999"}},[_c('a',{staticClass:"pull-right text-danger",attrs:{"type":"button","data-id":image.id},on:{"click":function($event){_vm.deleteSizeImage(size_container, image, $event)}}},[_c('i',{staticClass:"fa fa-times fa-fw"})]),_vm._v(" "),_c('span',{staticClass:"pull-left label dark-white text-color"},[_vm._v(_vm._s(size_container.images.length - $index))])]),_vm._v(" "),_c('div',{staticClass:"thumbnail"},[_c('img',{staticClass:"w-full",attrs:{"src":image.location,"data-gallery":'image-thumbs_'+size_container.id,"data-width":"100%","data-toggle":"lightbox","data-remote":image.location}})])]),_vm._v(" "),_c('input',{attrs:{"type":"hidden","name":'sizings['+size_container.id +'][images]['+image.key+'][data]'},domProps:{"value":image.json}}),_vm._v(" "),_c('div',{staticClass:"box-body m-t-0 p-t-0"},[_c('div',{staticClass:"image_item_component"},[_c('label',{staticClass:"text-muted text-sm m-b-0 p-b-0"},[_vm._v("Quantity:")]),_vm._v(" "),_c('input',{staticClass:"text-center image_qty_btn",attrs:{"type":"text","value":"1","name":'sizings['+size_container.id+'][images]['+image.key+'][qty]'},domProps:{"value":"1"}})])])])])}))]),_vm._v(" "),_c('div',{staticClass:"box-footer"},[_c('div',{staticClass:"form-group categories_wrapper",staticStyle:{"display":"none"}},[_c('input',{staticClass:"selectized",attrs:{"type":"text","disabled":size_container.images.length > 0,"id":'categories_input_'+size_container.id,"name":'sizings['+size_container.id+'][categories]',"placeholder":"Type categories or keywords"}})]),_vm._v(" "),_c('div',{staticClass:"clearfix"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-offset-3 col-sm-7"},[_c('span',{staticClass:"pull-left"},[_c('image-attach',{attrs:{"s3_key_url":_vm.s3_key_url,"user_hash":_vm.user_hash}})],1),_vm._v(" "),_c('button',{staticClass:"pull-left btn white btn-sm ",attrs:{"type":"button","disabled":size_container.images.length == 0},on:{"click":_vm.toggleCategory}},[_vm._v("Categories")])])])])])])])}))}
...
if (module.hot) {(function () {  var hotAPI = require("vueify/node_modules/vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-07ba4328", __vue__options__)
  } else {
    hotAPI.reload("data-v-07ba4328", __vue__options__)
  }
})()}
},{"../FileUpload.vue":8,"babel-runtime/core-js/json/stringify":1,"vue":5,"vueify/node_modules/vue-hot-reload-api":7}],11:[function(require,module,exports){
'use strict';
