...
},{"../../app/s3uploader":18,"../../vendor/fileupload/js/jquery.fileupload":22,"../../vendor/fileupload/js/jquery.fileupload-image":19,"../../vendor/fileupload/js/jquery.fileupload-process":20,"../../vendor/fileupload/js/jquery.fileupload-ui":21,"../../vendor/fileupload/js/jquery.iframe-transport":23,"../../vendor/fileupload/js/vendor/canvas-to-blob.min":24,"../../vendor/fileupload/js/vendor/jquery.ui.widget":25,"../../vendor/fileupload/js/vendor/load-image":26,"./current-user":12,"babel-runtime/core-js/json/stringify":1,"vue":8,"vue-hot-reload-api":6,"vueify/lib/insert-css":9}],11:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        removeTag: function removeTag(option) {
            var index = this.categories.indexOf(option);
            if (index > -1) {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div :id=\"'size_'+id\" class=\"sizing_container\" :data-id=\"id\">\n    <div class=\"box-body clearfix \">\n        <div class=\"form-group sizing-row row\">\n            <label class=\"col-sm-3 form-control-label\">Size</label>\n            <div class=\"col-sm-9\">\n                <div class=\"btn-group-prpl\" data-toggle=\"buttons\">\n                    <label class=\"form-control-label btn white\" v-for=\"size in sizings\" style=\"margin-right: 3px;\">\n                        <input required=\"\" aria-required=\"true\" validation=\"required\" type=\"radio\" :name=\"'sizings['+id +'][size_id]'\" id=\"option1\" autocomplete=\"off\" :value=\"size.id\"> {{ size.name }}\n                    </label>\n                </div>\n            </div>\n        </div>\n        <div class=\"row row-horizon clearfix\">\n            <div class=\"col-sm-4 thumbnail-container\" v-for=\"(image, $index) in images\">\n                <div class=\"box no-shadow m-b-0 p-t-1 p-b-1 r b-1 b b-a\">\n                    <div class=\"item\">\n                        <div class=\"item-overlay active p-l p-r \" style=\"z-index: 999;\">\n                            <a type=\"button\" style=\"\" @click=\"deleteImage(image, $event)\" :data-id=\"image.id\" class=\"pull-right text-danger\"><i class=\"fa fa-times fa-fw\"></i></a>\n                            <span class=\"pull-left label dark-white text-color\">{{ images.length - $index }}</span>\n                        </div>\n\n                        <div class=\"thumbnail\">\n                            <img :src=\"image.location\" :data-gallery=\"'image-thumbs_'+id\" data-width=\"100%\" class=\"w-full\" data-toggle=\"lightbox\" :data-remote=\"image.location\">\n                        </div>\n                    </div>\n                    <input type=\"hidden\" :name=\"'sizings['+id +'][images]['+image.key+'][data]'\" :value=\"image.json\">\n                    <div class=\"box-body m-t-0 p-b-0 p-t-0\">\n                        <div class=\"image_item_component\">\n                            <label class=\"text-muted text-sm m-b-0 p-b-0\">Quantity:</label>\n                            <input type=\"text\" value=\"1\" :name=\"'sizings['+id+'][images]['+image.key+'][qty]'\" class=\"text-center image_qty_btn\">\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n\n    </div>\n    <div class=\"box-footer\">\n        <div class=\"form-group categories_wrapper\">\n            <multiselect v-if=\"images.length > 0 &amp;&amp; display.categories\" v-model=\"category\" tag-placeholder=\"Add this as a new category\" placeholder=\"Add categories\" label=\"name\" track-by=\"name\" :options=\"categories\" :multiple=\"true\" :taggable=\"true\" @remove=\"removeTag\" @tag=\"addTag\">\n            </multiselect>\n            <template v-for=\"category in categories\">\n                <input type=\"hidden\" :value=\"category.name\" :name=\"'sizings['+id+'][categories][]'\" class=\"selectized\">\n            </template>\n        </div>\n        <div class=\"clearfix\">\n            <div class=\"row\">\n                <div class=\"col-sm-offset-3 col-sm-7\">\n                                    <span class=\"pull-left add-images-btn\">\n                                        <image-attach :s3_key_url=\"s3_key_url\"></image-attach>\n                                    </span>\n\n                    <button type=\"button\" class=\"pull-left btn add-categories-btn white btn-sm \" :disabled=\"images.length == 0\" @click=\"toggleCategory\">Categories</button>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-bf970970", module.exports)
  } else {
    hotAPI.update("_v-bf970970", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../../FileUpload.vue":10,"vue":8,"vue-hot-reload-api":6,"vue-multiselect":7}],14:[function(require,module,exports){
'use strict';
...
var _SizeContainer = require('./Size-Container.vue');

var _SizeContainer2 = _interopRequireDefault(_SizeContainer);
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('image:uploaded', function (el, responseData) {

            responseData.json = (0, _stringify2.default)(responseData);
            var sizeEl = el.closest('.sizing_container'),
                sizeContainerId = sizeEl.data('id');

            var container = $.findFirst(_this.size_containers, function (obj) {
         ...
         * Update the sizings.
         */
        $Bus.$on('style-changed', function (styleId) {
            var styleSizes = _this.getStyleSizes(styleId);
            if (styleSizes.length > 0) {
                _this.setSizings(styleSizes);
            }
        });
    },
    ...
    methods: {
        ...
        deleteSizeContainer: function deleteSizeContainer(size) {
            ...
            confirmModal(function ($noty) {
                var index = _this2.size_containers.indexOf(size);
                if (index != -1) {
                    _this2.size_containers.splice(index, 1);
                }
    ...
    components: {
        'size-container': _SizeContainer2.default
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <div class=\"box\" v-for=\"size_container in size_containers\">\n        <button type=\"button\" @click=\"deleteSizeContainer(size_container, $event)\" style=\"position: absolute; top: 0; right: 0; border: 0; border-radius: 0; opacity:.3\" class=\" m-l-1 pull-right btn white btn-xs text-muted \"><i class=\"fa fa-times\" aria-hidden=\"true\"></i></button>\n        <size-container :images=\"size_container.images\" :s3_key_url=\"s3_key_url\" :sizings=\"sizings\" :id=\"size_container.id\"></size-container>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6a068edb", module.exports)
  } else {
    hotAPI.update("_v-6a068edb", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./Size-Container.vue":13,"babel-runtime/core-js/json/stringify":1,"vue":8,"vue-hot-reload-api":6}],15:[function(require,module,exports){
'use strict';
...
},{"../../onboard":17}],16:[function(require,module,exports){
'use strict';

var _SizeContainers = require('./create/Size-Containers.vue');

var _SizeContainers2 = _interopRequireDefault(_SizeContainers);

var _onboard = require('./create/onboard');
...
new Vue({
    ...
    components: {
        ...
        'size-containers': _SizeContainers2.default
    }
});

},{"../Modal.vue":11,"./create/Size-Containers.vue":14,"./create/onboard":15}],17:[function(require,module,exports){
'use strict';
...
},{"intro.js":4}],18:[function(require,module,exports){
'use strict';
