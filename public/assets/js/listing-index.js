...
!function(e,p){"object"==typeof exports&&"object"==typeof module?module.exports=p():"function"==typeof define&&define.amd?define([],p):"object"==typeof exports?exports.VueInfiniteLoading=p():e.VueInfiniteLoading=p()}(this,function(){return function(e){function p(o){if(t[o])return t[o].exports;var n=t[o]={exports:{},id:o,loaded:!1};return e[o].call(n.exports,n,n.exports,p),n.loaded=!0,n.exports}var t={};return p.m=e,p.c=t,p.p="/",p(0)}([function(e,p,t){"use strict";function o(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(p,"__esModule",{value:!0});var n=t(4),i=o(n);p.default=i.default,"undefined"!=typeof window&&window.Vue&&window.Vue.component("infinite-loading",i.default)},function(e,p){"use strict";function t(e){return"BODY"===e.tagName?window:["scroll","auto"].indexOf(getComputedStyle(e).overflowY)>-1?e:t(e.parentNode)}function o(e,p){var t=void 0,o=isNaN(e.scrollTop)?e.pageYOffset:e.scrollTop;if("top"===p)t=o;else{var n=getComputedStyle(e===window?document.body:e),i=e===window?window.innerHeight:parseInt(n.height,10),a=e===window?document.body.scrollHeight:e.scrollHeight,x=parseInt(n.paddingTop,10),r=parseInt(n.paddingBottom,10);t=a-i-o-x-r}return t}Object.defineProperty(p,"__esModule",{value:!0});var n={bubbles:"loading-bubbles",circles:"loading-circles",default:"loading-default",spiral:"loading-spiral",waveDots:"loading-wave-dots"};p.default={data:function(){return{scrollParent:null,scrollHandler:null,isLoading:!1,isComplete:!1,isFirstLoad:!0}},computed:{spinnerType:function(){return n[this.spinner]||n.default}},props:{distance:{type:Number,default:100},onInfinite:Function,spinner:String,direction:{type:String,default:"bottom"}},mounted:function(){var e=this;this.scrollParent=t(this.$el),this.scrollHandler=function(){this.isLoading||this.attemptLoad()}.bind(this),setTimeout(this.scrollHandler,1),this.scrollParent.addEventListener("scroll",this.scrollHandler),this.$on("$InfiniteLoading:loaded",function(){e.isFirstLoad=!1,e.isLoading&&e.$nextTick(e.attemptLoad)}),this.$on("$InfiniteLoading:complete",function(){e.isLoading=!1,e.isComplete=!0,e.scrollParent.removeEventListener("scroll",e.scrollHandler)}),this.$on("$InfiniteLoading:reset",function(){e.isLoading=!1,e.isComplete=!1,e.isFirstLoad=!0,e.scrollParent.addEventListener("scroll",e.scrollHandler),setTimeout(e.scrollHandler,1)})},methods:{attemptLoad:function(){var e=o(this.scrollParent,this.direction);!this.isComplete&&e<=this.distance?(this.isLoading=!0,this.onInfinite.call()):this.isLoading=!1}},destroyed:function(){this.isComplete||this.scrollParent.removeEventListener("scroll",this.scrollHandler)}}},function(e,p,t){p=e.exports=t(3)(),p.push([e.id,'.loading-wave-dots[data-v-46e63502]{position:relative}.loading-wave-dots[data-v-46e63502]:before{content:"";position:absolute;top:50%;left:50%;margin-left:-4px;margin-top:-4px;width:8px;height:8px;background-color:#bbb;border-radius:50%;animation:linear loading-wave-dots 2.8s infinite}@keyframes loading-wave-dots{0%{box-shadow:-32px 0 0 #bbb,-16px 0 0 #bbb,16px 0 0 #bbb,32px 0 0 #bbb}5%{box-shadow:-32px -4px 0 #bbb,-16px 0 0 #bbb,16px 0 0 #bbb,32px 0 0 #bbb;transform:translateY(0)}10%{box-shadow:-32px -6px 0 #999,-16px -4px 0 #bbb,16px 0 0 #bbb,32px 0 0 #bbb;transform:translateY(0)}15%{box-shadow:-32px 2px 0 #bbb,-16px -2px 0 #999,16px 4px 0 #bbb,32px 4px 0 #bbb;transform:translateY(-4px);background-color:#bbb}20%{box-shadow:-32px 6px 0 #bbb,-16px 4px 0 #bbb,16px 2px 0 #bbb,32px 6px 0 #bbb;transform:translateY(-6px);background-color:#999}25%{box-shadow:-32px 2px 0 #bbb,-16px 2px 0 #bbb,16px -4px 0 #999,32px -2px 0 #bbb;transform:translateY(-2px);background-color:#bbb}30%{box-shadow:-32px 0 0 #bbb,-16px 0 0 #bbb,16px -2px 0 #bbb,32px -6px 0 #999;transform:translateY(0)}35%{box-shadow:-32px 0 0 #bbb,-16px 0 0 #bbb,16px 0 0 #bbb,32px -2px 0 #bbb}40%{box-shadow:-32px 0 0 #bbb,-16px 0 0 #bbb,16px 0 0 #bbb,32px 0 0 #bbb}to{box-shadow:-32px 0 0 #bbb,-16px 0 0 #bbb,16px 0 0 #bbb,32px 0 0 #bbb}}.loading-circles[data-v-46e63502]{position:relative}.loading-circles[data-v-46e63502]:before{content:"";position:absolute;left:50%;top:50%;margin-top:-2.5px;margin-left:-2.5px;width:5px;height:5px;border-radius:50%;animation:linear loading-circles .75s infinite}@keyframes loading-circles{0%{box-shadow:0 -12px 0 #505050,8.52px -8.52px 0 #646464,12px 0 0 #797979,8.52px 8.52px 0 #8d8d8d,0 12px 0 #a2a2a2,-8.52px 8.52px 0 #b6b6b6,-12px 0 0 #cacaca,-8.52px -8.52px 0 #dfdfdf}12.5%{box-shadow:0 -12px 0 #dfdfdf,8.52px -8.52px 0 #505050,12px 0 0 #646464,8.52px 8.52px 0 #797979,0 12px 0 #8d8d8d,-8.52px 8.52px 0 #a2a2a2,-12px 0 0 #b6b6b6,-8.52px -8.52px 0 #cacaca}25%{box-shadow:0 -12px 0 #cacaca,8.52px -8.52px 0 #dfdfdf,12px 0 0 #505050,8.52px 8.52px 0 #646464,0 12px 0 #797979,-8.52px 8.52px 0 #8d8d8d,-12px 0 0 #a2a2a2,-8.52px -8.52px 0 #b6b6b6}37.5%{box-shadow:0 -12px 0 #b6b6b6,8.52px -8.52px 0 #cacaca,12px 0 0 #dfdfdf,8.52px 8.52px 0 #505050,0 12px 0 #646464,-8.52px 8.52px 0 #797979,-12px 0 0 #8d8d8d,-8.52px -8.52px 0 #a2a2a2}50%{box-shadow:0 -12px 0 #a2a2a2,8.52px -8.52px 0 #b6b6b6,12px 0 0 #cacaca,8.52px 8.52px 0 #dfdfdf,0 12px 0 #505050,-8.52px 8.52px 0 #646464,-12px 0 0 #797979,-8.52px -8.52px 0 #8d8d8d}62.5%{box-shadow:0 -12px 0 #8d8d8d,8.52px -8.52px 0 #a2a2a2,12px 0 0 #b6b6b6,8.52px 8.52px 0 #cacaca,0 12px 0 #dfdfdf,-8.52px 8.52px 0 #505050,-12px 0 0 #646464,-8.52px -8.52px 0 #797979}75%{box-shadow:0 -12px 0 #797979,8.52px -8.52px 0 #8d8d8d,12px 0 0 #a2a2a2,8.52px 8.52px 0 #b6b6b6,0 12px 0 #cacaca,-8.52px 8.52px 0 #dfdfdf,-12px 0 0 #505050,-8.52px -8.52px 0 #646464}87.5%{box-shadow:0 -12px 0 #646464,8.52px -8.52px 0 #797979,12px 0 0 #8d8d8d,8.52px 8.52px 0 #a2a2a2,0 12px 0 #b6b6b6,-8.52px 8.52px 0 #cacaca,-12px 0 0 #dfdfdf,-8.52px -8.52px 0 #505050}to{box-shadow:0 -12px 0 #505050,8.52px -8.52px 0 #646464,12px 0 0 #797979,8.52px 8.52px 0 #8d8d8d,0 12px 0 #a2a2a2,-8.52px 8.52px 0 #b6b6b6,-12px 0 0 #cacaca,-8.52px -8.52px 0 #dfdfdf}}.loading-bubbles[data-v-46e63502]{position:relative}.loading-bubbles[data-v-46e63502]:before{content:"";position:absolute;left:50%;top:50%;margin-top:-.5px;margin-left:-.5px;width:1px;height:1px;border-radius:50%;animation:linear loading-bubbles .85s infinite}@keyframes loading-bubbles{0%{box-shadow:0 -12px 0 .4px #666,8.52px -8.52px 0 .8px #666,12px 0 0 1.2px #666,8.52px 8.52px 0 1.6px #666,0 12px 0 2px #666,-8.52px 8.52px 0 2.4px #666,-12px 0 0 2.8px #666,-8.52px -8.52px 0 3.2px #666}12.5%{box-shadow:0 -12px 0 3.2px #666,8.52px -8.52px 0 .4px #666,12px 0 0 .8px #666,8.52px 8.52px 0 1.2px #666,0 12px 0 1.6px #666,-8.52px 8.52px 0 2px #666,-12px 0 0 2.4px #666,-8.52px -8.52px 0 2.8px #666}25%{box-shadow:0 -12px 0 2.8px #666,8.52px -8.52px 0 3.2px #666,12px 0 0 .4px #666,8.52px 8.52px 0 .8px #666,0 12px 0 1.2px #666,-8.52px 8.52px 0 1.6px #666,-12px 0 0 2px #666,-8.52px -8.52px 0 2.4px #666}37.5%{box-shadow:0 -12px 0 2.4px #666,8.52px -8.52px 0 2.8px #666,12px 0 0 3.2px #666,8.52px 8.52px 0 .4px #666,0 12px 0 .8px #666,-8.52px 8.52px 0 1.2px #666,-12px 0 0 1.6px #666,-8.52px -8.52px 0 2px #666}50%{box-shadow:0 -12px 0 2px #666,8.52px -8.52px 0 2.4px #666,12px 0 0 2.8px #666,8.52px 8.52px 0 3.2px #666,0 12px 0 .4px #666,-8.52px 8.52px 0 .8px #666,-12px 0 0 1.2px #666,-8.52px -8.52px 0 1.6px #666}62.5%{box-shadow:0 -12px 0 1.6px #666,8.52px -8.52px 0 2px #666,12px 0 0 2.4px #666,8.52px 8.52px 0 2.8px #666,0 12px 0 3.2px #666,-8.52px 8.52px 0 .4px #666,-12px 0 0 .8px #666,-8.52px -8.52px 0 1.2px #666}75%{box-shadow:0 -12px 0 1.2px #666,8.52px -8.52px 0 1.6px #666,12px 0 0 2px #666,8.52px 8.52px 0 2.4px #666,0 12px 0 2.8px #666,-8.52px 8.52px 0 3.2px #666,-12px 0 0 .4px #666,-8.52px -8.52px 0 .8px #666}87.5%{box-shadow:0 -12px 0 .8px #666,8.52px -8.52px 0 1.2px #666,12px 0 0 1.6px #666,8.52px 8.52px 0 2px #666,0 12px 0 2.4px #666,-8.52px 8.52px 0 2.8px #666,-12px 0 0 3.2px #666,-8.52px -8.52px 0 .4px #666}to{box-shadow:0 -12px 0 .4px #666,8.52px -8.52px 0 .8px #666,12px 0 0 1.2px #666,8.52px 8.52px 0 1.6px #666,0 12px 0 2px #666,-8.52px 8.52px 0 2.4px #666,-12px 0 0 2.8px #666,-8.52px -8.52px 0 3.2px #666}}.loading-default[data-v-46e63502]{position:relative;border:1px solid #999;animation:ease loading-rotating 1.5s infinite}.loading-default[data-v-46e63502]:before{content:"";position:absolute;display:block;top:0;left:50%;margin-top:-3px;margin-left:-3px;width:6px;height:6px;background-color:#999;border-radius:50%}.loading-spiral[data-v-46e63502]{border:2px solid #777;border-right-color:transparent;animation:linear loading-rotating .85s infinite}@keyframes loading-rotating{0%{transform:rotate(0)}to{transform:rotate(1turn)}}.infinite-loading-container[data-v-46e63502]{clear:both;text-align:center}.infinite-loading-container [class^=loading-][data-v-46e63502]{display:inline-block;margin:15px 0;width:28px;height:28px;font-size:28px;line-height:28px;border-radius:50%}.infinite-status-prompt[data-v-46e63502]{color:#666;font-size:14px;text-align:center;padding:10px 0}',""])},function(e,p){e.exports=function(){var e=[];return e.toString=function(){for(var e=[],p=0;p<this.length;p++){var t=this[p];t[2]?e.push("@media "+t[2]+"{"+t[1]+"}"):e.push(t[1])}return e.join("")},e.i=function(p,t){"string"==typeof p&&(p=[[null,p,""]]);for(var o={},n=0;n<this.length;n++){var i=this[n][0];"number"==typeof i&&(o[i]=!0)}for(n=0;n<p.length;n++){var a=p[n];"number"==typeof a[0]&&o[a[0]]||(t&&!a[2]?a[2]=t:t&&(a[2]="("+a[2]+") and ("+t+")"),e.push(a))}},e}},function(e,p,t){var o,n;t(7),o=t(1);var i=t(5);n=o=o||{},"object"!=typeof o.default&&"function"!=typeof o.default||(n=o=o.default),"function"==typeof n&&(n=n.options),n.render=i.render,n.staticRenderFns=i.staticRenderFns,n._scopeId="data-v-46e63502",e.exports=o},function(e,p){e.exports={render:function(){var e=this,p=e.$createElement,t=e._self._c||p;return t("div",{staticClass:"infinite-loading-container"},[t("div",{directives:[{name:"show",rawName:"v-show",value:e.isLoading,expression:"isLoading"}]},[e._t("spinner",[t("i",{class:e.spinnerType})])],2),e._v(" "),t("div",{directives:[{name:"show",rawName:"v-show",value:!e.isLoading&&e.isComplete&&e.isFirstLoad,expression:"!isLoading && isComplete && isFirstLoad"}],staticClass:"infinite-status-prompt"},[e._t("no-results",[e._v("No results :(")])],2),e._v(" "),t("div",{directives:[{name:"show",rawName:"v-show",value:!e.isLoading&&e.isComplete&&!e.isFirstLoad,expression:"!isLoading && isComplete && !isFirstLoad"}],staticClass:"infinite-status-prompt"},[e._t("no-more",[e._v("No more data :)")])],2)])},staticRenderFns:[]}},function(e,p,t){function o(e,p){for(var t=0;t<e.length;t++){var o=e[t],n=l[o.id];if(n){n.refs++;for(var i=0;i<n.parts.length;i++)n.parts[i](o.parts[i]);for(;i<o.parts.length;i++)n.parts.push(r(o.parts[i],p))}else{for(var a=[],i=0;i<o.parts.length;i++)a.push(r(o.parts[i],p));l[o.id]={id:o.id,refs:1,parts:a}}}}function n(e){for(var p=[],t={},o=0;o<e.length;o++){var n=e[o],i=n[0],a=n[1],x=n[2],r=n[3],s={css:a,media:x,sourceMap:r};t[i]?t[i].parts.push(s):p.push(t[i]={id:i,parts:[s]})}return p}function i(e,p){var t=c(),o=g[g.length-1];if("top"===e.insertAt)o?o.nextSibling?t.insertBefore(p,o.nextSibling):t.appendChild(p):t.insertBefore(p,t.firstChild),g.push(p);else{if("bottom"!==e.insertAt)throw new Error("Invalid value for parameter 'insertAt'. Must be 'top' or 'bottom'.");t.appendChild(p)}}function a(e){e.parentNode.removeChild(e);var p=g.indexOf(e);p>=0&&g.splice(p,1)}function x(e){var p=document.createElement("style");return p.type="text/css",i(e,p),p}function r(e,p){var t,o,n;if(p.singleton){var i=h++;t=u||(u=x(p)),o=s.bind(null,t,i,!1),n=s.bind(null,t,i,!0)}else t=x(p),o=d.bind(null,t),n=function(){a(t)};return o(e),function(p){if(p){if(p.css===e.css&&p.media===e.media&&p.sourceMap===e.sourceMap)return;o(e=p)}else n()}}function s(e,p,t,o){var n=t?"":o.css;if(e.styleSheet)e.styleSheet.cssText=v(p,n);else{var i=document.createTextNode(n),a=e.childNodes;a[p]&&e.removeChild(a[p]),a.length?e.insertBefore(i,a[p]):e.appendChild(i)}}function d(e,p){var t=p.css,o=p.media,n=p.sourceMap;if(o&&e.setAttribute("media",o),n&&(t+="\n/*# sourceURL="+n.sources[0]+" */",t+="\n/*# sourceMappingURL=data:application/json;base64,"+btoa(unescape(encodeURIComponent(JSON.stringify(n))))+" */"),e.styleSheet)e.styleSheet.cssText=t;else{for(;e.firstChild;)e.removeChild(e.firstChild);e.appendChild(document.createTextNode(t))}}var l={},b=function(e){var p;return function(){return"undefined"==typeof p&&(p=e.apply(this,arguments)),p}},f=b(function(){return/msie [6-9]\b/.test(window.navigator.userAgent.toLowerCase())}),c=b(function(){return document.head||document.getElementsByTagName("head")[0]}),u=null,h=0,g=[];e.exports=function(e,p){p=p||{},"undefined"==typeof p.singleton&&(p.singleton=f()),"undefined"==typeof p.insertAt&&(p.insertAt="bottom");var t=n(e);return o(t,p),function(e){for(var i=[],a=0;a<t.length;a++){var x=t[a],r=l[x.id];r.refs--,i.push(r)}if(e){var s=n(e);o(s,p)}for(var a=0;a<i.length;a++){var r=i[a];if(0===r.refs){for(var d=0;d<r.parts.length;d++)r.parts[d]();delete l[r.id]}}}};var v=function(){var e=[];return function(p,t){return e[p]=t,e.filter(Boolean).join("\n")}}()},function(e,p,t){var o=t(2);"string"==typeof o&&(o=[[e.id,o,""]]);t(6)(o,{});o.locals&&(e.exports=o.locals)}])});
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-45a056e0", module.exports)
  } else {
    hotAPI.update("_v-45a056e0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-78c044e8", module.exports)
  } else {
    hotAPI.update("_v-78c044e8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./spinner":15,"vue":5,"vue-hot-reload-api":2}],8:[function(require,module,exports){
"use strict";
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<span>\n    <button :disabled=\"processing || disable || entityIsMe\" type=\"button\" @click=\"is_following ? unfollowMe($event) : followMe($event)\" class=\"btn-follow btn \" :class=\"btnclass\">\n        <span v-html=\"is_following ? unfollow_text : follow_text\"></span>\n        <spinner v-if=\"processing\" :size=\"'' + 10\"></spinner>\n    </button>\n</span>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1a99479c", module.exports)
  } else {
    hotAPI.update("_v-1a99479c", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Spinner.vue":7,"../current-user":8,"vue":5,"vue-hot-reload-api":2}],10:[function(require,module,exports){
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"col-md-3\" :data-id=\"item.id\" :data-size-id=\"inventory_item.inventory_sizes_id\" :data-style-id=\"inventory_item.inventory_type_styles_id\">\n    <div class=\"box p-a-xs p-b-0\">\n        <span class=\"item avatar_container block-center center _128h avatar-thumbnail\">\n            <div class=\"item-overlay active p-a-xs\" style=\"z-index:999\">\n                <followable able_name=\"watchable\" unfollow_text=\"Watching\" follow_text=\"Watch\" show_on_hover=\"1\" btn_size_class=\"pull-right label dark-white text-color btn-xs\" able_type=\"Kabooodle\\Models\\ListingItems\" :able_id=\"'' + item.id\" :already_following=\"item.is_watched ? true : false\" :endpoint=\"watch_endpoint\"></followable>\n            </div>\n            <a :href=\"show_endpoint\">\n                <img :src=\"inventory_item.cover_photo.location\" class=\"img-responsive\">\n            </a>\n        </span>\n        <div class=\"p-a-sm p-b-0\">\n            <div class=\"clearfix\">\n                <h6 class=\"m-b-0\">\n                    <a class=\"\" :href=\"show_endpoint\">\n                        {{ inventory_item.name }}\n                    </a>\n                </h6>\n                <div class=\"m-b-0 text-sm clearfix\">\n                    <div class=\"pull-left\">\n                        <div class=\"block\">\n                            <span class=\"text-muted\">Size:</span><span class=\"\">{{ inventory_item.style_size.name }}</span>\n                        </div>\n                    </div>\n                    <div class=\"pull-right\" style=\"text-align: right\">\n                        <span class=\"text-muted \">Qty:</span> <span class=\"\">{{ inventory_item.available_quantity }}</span>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5e7646f1", module.exports)
  } else {
    hotAPI.update("_v-5e7646f1", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../follow/Followable.vue":9,"vue":5,"vue-hot-reload-api":2}],11:[function(require,module,exports){
'use strict';
...
var _ListingCard = require('./ListingCard.vue');
...
var _vueInfiniteLoading = require('vue-infinite-loading');
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('listing-filter:request', function (styles, sizes, sellers) {
            _this.filtering = true;
            _this.filters.styles = styles;
            _this.filters.sizes = sizes;
            _this.filters.sellers = sellers;
            _this.items = [];
            _this.fetchItems(_this.fetch_endpoint, { styles: styles, sizes: sizes, sellers: sellers });
        });
    ...
    methods: {
        ...
        fetchInfinite: function fetchInfinite() {
            ...
            if (url) {
                ...
                this.$nextTick(function () {
                    _this2.$refs.listingFinite.$emit('$InfiniteLoading:complete');
                });
            }
        },
         ...
         * @param data
         */
        fetchItems: function fetchItems(url, data) {
            var _this3 = this;
        ...
        handleResponse: function handleResponse(response) {
            ...
            if (this.filtering) {
                ...
                _.each(response.body.data.data, function (a) {
                    _this4.items.push(a);
                });
            }
            ...
            this.$nextTick(function () {
                if (_this4.items.length >= _this4.pagination.total) {
                    _this4.$refs.listingFinite.$emit('$InfiniteLoading:complete');
                } else {
                    _this4.$refs.listingFinite.$emit('$InfiniteLoading:loaded');
                }
            });
    ...
    components: {
        ...
        'listing-card': _ListingCard2.default,
        InfiniteLoading: _vueInfiniteLoading2.default
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <spinny v-if=\"fetching\" :size=\"'' + 28\" class=\"text-center center-block\"></spinny>\n        <listing-card v-for=\"item in items\" :key=\"item.id\" :item=\"item\" :inventory_item=\"item.inventory_item\" :watch_endpoint=\"watch_endpoint.replace(/::1::/, item.listing_id).replace(/::2::/, item.id)\" :show_endpoint=\"show_endpoint.replace(/::1::/, item.id_to_string)\"></listing-card>\n        <infinite-loading :distance=\"100\" :on-infinite=\"fetchInfinite\" ref=\"listingFinite\">\n            <span slot=\"no-more\">\n                No more results.\n            </span>\n            <span slot=\"no-results\">\n                No more results.\n            </span>\n            <span slot=\"spinner\">\n                <spinny class=\"text-center center-block\" :size=\"'' + 38\"></spinny>\n            </span>\n        </infinite-loading>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-73fe3852", module.exports)
  } else {
    hotAPI.update("_v-73fe3852", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Spinner.vue":7,"./ListingCard.vue":10,"vue":5,"vue-hot-reload-api":2,"vue-infinite-loading":3}],12:[function(require,module,exports){
'use strict';
...
var _ListingCards = require('./ListingCards.vue');

var _ListingCards2 = _interopRequireDefault(_ListingCards);
...
new Vue({
    ...
    mounted: function mounted() {
        ...
        $Bus.$on('listing-filter:completed', function (items) {
            _this.filtered = items.length;
            _this.filtering = false;
        });
    },

    computed: {
        has_filters: function has_filters() {
            return this.styles.length > 0 || this.sizes.length > 0;
        }
    },
    methods: {
        toggleStyleListItem: function toggleStyleListItem(styleId, event) {
            var $el = $(event.target).closest('.style-list-item');
            styleId = parseInt(styleId);
            if ($el.hasClass('active')) {
                $el.removeClass('active');
                var index = this.styles.indexOf(styleId);
                if (index >= 0) {
        ...
        toggleSizeListItem: function toggleSizeListItem(sizeId, styleId, event) {
            var $el = $(event.target).closest('.size-list-item');
            ...
            if ($el.hasClass('active')) {
                ...
                var index = this.sizes.indexOf(sizeId);
                if (index >= 0) {
        ...
        filterListing: function filterListing() {
            this.filtering = true;
            $Bus.$emit('listing-filter:request', this.styles, this.sizes);
        }
    },
    components: {
        'listing-cards': _ListingCards2.default,
        'v-card': _VCard2.default,
        'spinny': _Spinner2.default
    }
});

},{"../Spinner.vue":7,"../users/V-Card.vue":16,"./ListingCards.vue":11}],13:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-700eadae", module.exports)
  } else {
    hotAPI.update("_v-700eadae", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Spinner.vue":7,"../current-user":8,"./MessageUserModal.vue":14,"vue":5,"vue-hot-reload-api":2}],14:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-95e7aa98", module.exports)
  } else {
    hotAPI.update("_v-95e7aa98", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Modal.vue":6,"../Spinner.vue":7,"../current-user":8,"vue":5,"vue-hot-reload-api":2,"vue-multiselect":4}],15:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-b5e929aa", module.exports)
  } else {
    hotAPI.update("_v-b5e929aa", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../current-user":8,"../follow/Followable.vue":9,"../messenger/MessageUser.vue":13,"vue":5,"vue-hot-reload-api":2}]},{},[12]);

//# sourceMappingURL=listing-index.js.map
