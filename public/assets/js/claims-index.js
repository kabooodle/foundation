...
exports.default = {
    ...
    methods: {
        ...
        acceptClaim: function acceptClaim(claim) {
            this.$http.put().then(function (response) {}, function (response) {
                notify();
            });
        },
        rejectClaim: function rejectClaim(claim) {
            this.$http.delete().then(function (response) {}, function (response) {
                notify();
            });
        }
    },
