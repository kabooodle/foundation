...
},{"./spinner":10,"vue":3,"vue-hot-reload-api":2}],6:[function(require,module,exports){
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"form-group row\">\n    <div class=\"col-sm-8\">\n        <span>\n            <strong>{{ address.name }}</strong>\n            <span class=\"block\">{{ address.street1 }}, {{ address.city }}, {{ address.state }}, {{ address.zip }}</span>\n        </span>\n    </div>\n    <div class=\"col-sm-3\">\n        <div v-show=\"isPrimary\">\n            <div class=\"text-primary text-center\">Primary</div>\n        </div>\n        <div v-show=\"!isPrimary\">\n            <button :disabled=\"makingprimary\" :class=\"makingprimary ? 'disabled' : null\" @click=\"makePrimary\" class=\"btn white btn-sm btn-block p-x-md\">\n                Make Primary <spinny v-if=\"makingprimary\"></spinny>\n            </button>\n        </div>\n    </div>\n    <div class=\"col-sm-1\">\n        <span v-show=\"!isPrimary\" @click=\"destroy\">\n            <i class=\"fa fa-times text-danger\" aria-hidden=\"true\"></i>\n        </span>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4c35614c", module.exports)
  } else {
    hotAPI.update("_v-4c35614c", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Spinner.vue":5,"vue":3,"vue-hot-reload-api":2}],7:[function(require,module,exports){
'use strict';
    ...
    methods: {
        ...
        saveAddress: function saveAddress() {
            ...
            this.$http.post(this.addressesEndpoint, this.addressData).then(function (response) {
                var new_address = response.data.data.address;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-71f289fa", module.exports)
  } else {
    hotAPI.update("_v-71f289fa", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Spinner.vue":5,"../address/Address.vue":6,"vue":3,"vue-hot-reload-api":2}],8:[function(require,module,exports){
...
exports.default = {
    ...
    methods: {
        updateShippingProfile: function updateShippingProfile() {
            this.$http.put(this.shippingProfileUpdateEndpoint, this.updateShippingProfileData).then(function (response) {
                notify({
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-26536f17", module.exports)
  } else {
    hotAPI.update("_v-26536f17", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../address/Addresses.vue":7,"vue":3,"vue-hot-reload-api":2,"vueify/lib/insert-css":4}],9:[function(require,module,exports){
'use strict';
...
new Vue({
    ...
    components: {
        'shipping-profile': _ShippingProfile2.default
    }
});

},{"./ShippingProfile.vue":8}],10:[function(require,module,exports){
'use strict';
