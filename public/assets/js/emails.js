...
exports.default = {
    ...
    methods: {
        ...
        makePrimary: function makePrimary(event) {
        ...
        resendVerification: function resendVerification(event) {
            event.preventDefault();
            var el = event.target;
            var innerHtml = el.innerHTML;
            el.classList.add('disabled');
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-f8cd0548", module.exports)
  } else {
    hotAPI.update("_v-f8cd0548", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
    ...
    methods: {
        ...
        saveEmail: function saveEmail() {
            ...
            this.$http.post(this.newEmailEndpoint, this.newEmailData).then(function (response) {
                _this.emails.push(response.data.data.email);
                _this.addingEmail = false;
                notify({
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-197c6172", module.exports)
  } else {
    hotAPI.update("_v-197c6172", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
