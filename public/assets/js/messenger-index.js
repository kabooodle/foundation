...
},{"./spinner":13,"vue":4,"vue-hot-reload-api":2}],7:[function(require,module,exports){
'use strict';
...
},{"../Modal.vue":5,"../Spinner.vue":6,"../current-user":8,"vue":4,"vue-hot-reload-api":2,"vue-multiselect":3}],10:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    computed: {
        ...
        most_recent_message: function most_recent_message() {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-e5810dba", module.exports)
  } else {
    hotAPI.update("_v-e5810dba", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Timestamp.vue":7,"../current-user":8,"vue":4,"vue-hot-reload-api":2}],11:[function(require,module,exports){
'use strict';
...
var _Thread = require('./Thread.vue');
...
exports.default = {
    ...
    methods: {
        fetchThreads: function fetchThreads(url) {
            var _this = this;

            url = url || this.endpoint;
            this.fetching = true;
            this.$http.get(url).then(function (response) {
                _this.threads = response.body.data.data;
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <spinny v-if=\"fetching\" :size=\"'' + 28\" class=\"text-center center-block\"></spinny>\n    <div class=\"list white\" v-if=\"threads\">\n        <thread v-for=\"thread in threads\" :thread=\"thread\" :endpoint=\"thread_endpoint.replace(/::ID::/, thread.id)\"></thread>\n    </div>\n    <div v-if=\"!fetching &amp;&amp; threads.length == 0\">\n        <p class=\"text-center\">Your inbox is empty.</p>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1e5b4c60", module.exports)
  } else {
    hotAPI.update("_v-1e5b4c60", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Spinner.vue":6,"./Thread.vue":10,"vue":4,"vue-hot-reload-api":2}],12:[function(require,module,exports){
'use strict';
...
},{"./MessageUserModal.vue":9,"./Threads.vue":11}],13:[function(require,module,exports){
'use strict';
