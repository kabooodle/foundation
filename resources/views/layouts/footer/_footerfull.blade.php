...
<div class="footer prpl-800 dk pos-rlt" style="background: url('/assets/images/rhombus-bg.png') bottom repeat-x;">
    <div class="padding">
        <div class=" p-a center-block">
            <h3 class="text-center footer-slogan">A community of everything and more!</h3>
        </div>
        <hr>
        <div class=" p-a center-block">
            &copy; 2016
