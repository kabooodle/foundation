    ...
    <div class="box white">
        ...
        <div class="box-body">
            <div class="form-group row {{ $errors->has('claim_id') ? 'has-danger' : null }}" id="packaging-wrapper">
                ...
                <div class="col-sm-6">
                    {{ Form::select('claim_id', ['self' => 'Manual Input'] + ['Not processed' => user()->claimsAsSeller->pluck('claimer_item_date_price','uuid')->toArray()], Binput::get('c', null), ['class' => 'form-control', 'id' => 'claimer_select_el'])  }}
                </div>
            </div>
        </div>
    </div>
