...
@section('body-menu')
    ...
    <div class="clearfix">
        ...
        <div class="btn-toolbar pull-right">
            ...
            @else
                <a data-toggle="modal" data-target="#modal_claim_wrapper" data-backdrop="static" data-keyboard="false" href="{{ route('externalclaim.claim', [$facebook->obfuscateIdToString()]) }}" class="btn btn-sm claim  _800 ">Claim it now!</a>
            @endif
