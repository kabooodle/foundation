<div class="form-group row {{ $errors->has($_key.'.company') ? 'has-danger' : null }}">
    <label class="control-label col-sm-3">Company Name<small class="block text-muted">(Optional)</small></label>
    <div class="col-sm-6">
...
<div class="form-group row {{ $errors->has($_key.'.street2') ? 'has-danger' : null }}">
    <label class="control-label col-sm-3">Street 2<small class="block text-muted">(Optional)</small></label>
    <div class="col-sm-6">
...
<div class="form-group row {{ $errors->has($_key.'.phone') ? 'has-danger' : null }}">
    <label class="control-label col-sm-3">Phone <small class="block text-muted">(Optional)</small></label>
    <div class="col-md-4">
