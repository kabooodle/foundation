...
<p>Someone (hopefully you) has used this email at {{ env('APP_NAME') }} to claim an item. Please click the button below to verify the claim. The claim will not go through until you do so.</p>
