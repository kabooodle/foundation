...
<head>
    ...
    <title>{{ $subject or 'Kabooodle Email' }}</title>
    <style type="text/css">
        body {
                                                            ...
                                                            <td valign='top' align='center'>
                                                                <div class="contentEditableContainer contentImageEditable">
                                                                    <div class="contentEditable">
                                                                        <img src="http://kabooodle.net/assets/images/logo/logo-prpl.png" width='120' height='32' alt='' data-default="placeholder" data-max-width="560">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
