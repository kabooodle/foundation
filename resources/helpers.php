...
if (!function_exists('getMimeContentType')) {
    ...
    function getMimeContentType($filename)
    {
        ...
        // this allows a file path or file name to be passed in
        ...
        if (array_key_exists($ext, $mimeTypes)) {
            ...
            finfo_close($fInfo);
            // because sometimes it returns a multipart mime type with a semicolon delimiter
...
if (! function_exists('getEnvDomain')) {
    ...
    function getEnvDomain($withTld = false)
    {
        ...
        if (in_array($httpHost, ['kabooodle.ngrok.io'])) {
